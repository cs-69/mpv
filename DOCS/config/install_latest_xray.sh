...
place_xray() {
    install -m 755 "${TMP_DIRECTORY}/xray" "/var/lib/marzban/core/xray"
    install -d "/var/lib/marzban/core/xray/"
    install -m 644 "${TMP_DIRECTORY}/geoip.dat" "/var/lib/marzban/core/geoip.dat"
    install -m 644 "${TMP_DIRECTORY}/geosite.dat" "/var/lib/marzban/core/geosite.dat"
